...
# Data
train_data = datasets.MNIST(root='LSTM/mnist_train_data', train=True, download=True, transform=transform)
test_data = datasets.MNIST(root='LSTM/mnist_test_data', train=False, download=True, transform=transform)
...
torch.save(model.state_dict(), 'LSTM/lstm_handwritten_number_pred.pth')
